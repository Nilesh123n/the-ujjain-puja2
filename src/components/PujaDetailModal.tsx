      ...
      >
        ...
        <div className="p-6 sm:p-8 space-y-6">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
            <div className="bg-[#FDF6EC] border border-[#F5E6D0] p-3 rounded-xl flex items-center gap-3">
          ...
          <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
              {benefits.map((b, idx) => (
                <div key={idx} className="flex items-center gap-2 text-xs text-[#2C1A0E] bg-[#FDF6EC] p-2.5 rounded-lg border border-[#F5E6D0]">
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-2">
              {includes.map((inc, idx) => (
                <span key={idx} className="bg-[#F5E6D0] border border-[#f7ae62]/50 text-[#5C3A1E] text-xs font-medium px-3 py-1.5 rounded-full">
                  ✓ {inc}
                </span>
              ))}
            </div>
          ...
          {/* BEST FOR */}
          {bestFor && (
            <div className="bg-[#FDF6EC] p-3.5 rounded-xl border border-[#F5E6D0]">
        ...
        {/* FOOTER */}
        <div className="p-6 bg-[#FDF6EC] border-t border-[#F5E6D0] flex flex-col sm:flex-row items-center justify-between gap-4">
          <div>
