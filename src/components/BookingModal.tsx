  ...
  return (
    ...
    >
      ...
      >
        ...
        <button
          onClick={onClose}
          className="absolute top-4 right-4 w-9 h-9 rounded-full bg-[#F5E6D0] border border-[#f7ae62] text-[#5C3A1E] font-bold text-lg hover:bg-[#f7ae62] hover:text-white transition-all flex items-center justify-center z-10 cursor-pointer"
        >
          ✕
        </button>
        ...
        <form onSubmit={handleSubmit} className="p-5 sm:p-7 space-y-4">
          ...
          <div>
            ...
            <select
              ...
              className="w-full bg-[#FDF6EC] border-2 border-[#F5E6D0] focus:border-[#f7ae62] rounded-xl px-3.5 py-2.5 text-sm font-semibold text-[#2C1A0E] outline-none"
            >
              {PUJA_DATA.map((p) => (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <div>
              ...
              <input
                ...
                className="w-full bg-[#FDF6EC] border-2 border-[#F5E6D0] focus:border-[#f7ae62] focus:bg-white rounded-xl px-3.5 py-2.5 text-sm text-[#2C1A0E] outline-none transition-all"
              />
            </div>
            <div>
              <label className="block text-xs font-bold text-[#5C3A1E] uppercase tracking-wider mb-1">
          ...
          <div className="grid grid-cols-3 gap-2">
            <div>
              ...
              <input
                ...
                className="w-full bg-[#FDF6EC] border border-[#F5E6D0] rounded-xl px-2.5 py-2 text-xs text-[#2C1A0E] outline-none"
              />
            </div>
            <div>
            ...
            <div>
              ...
              <select
                ...
                className="w-full bg-[#FDF6EC] border border-[#F5E6D0] rounded-xl px-2 py-2 text-xs text-[#2C1A0E] outline-none"
              >
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full bg-[#FDF6EC] border-2 border-[#F5E6D0] focus:border-[#f7ae62] rounded-xl px-3.5 py-2 text-xs text-[#2C1A0E] outline-none resize-none"
            />
          </div>

          {/* COUPON SECTION */}
          <div className="bg-[#FDF6EC] p-3 rounded-xl border border-[#F5E6D0] flex flex-col gap-2">
            <div className="flex gap-2">
              <input
                ...
                className="flex-1 uppercase bg-white border border-[#F5E6D0] rounded-lg px-3 py-1.5 text-xs font-bold tracking-wider outline-none"
              />
              <button
                type="button"
                onClick={applyCoupon}
              ...
              <label
                className={`flex flex-col items-center justify-center p-2.5 rounded-xl border-2 cursor-pointer transition-all ${
                  paymentMethod === 'razorpay'
                    ? 'border-[#f7ae62] bg-[#F5E6D0] text-[#5C3A1E] font-bold'
                    : 'border-[#F5E6D0] bg-[#FDF6EC] text-[#8B6F5E]'
                }`}
              >
                <input
                  type="radio"
          ...
          {/* TOTAL & SUBMIT */}
          <div className="pt-2 border-t border-[#F5E6D0] space-y-3">
            <div className="bg-[#F5E6D0] p-3.5 rounded-xl border border-[#f7ae62] flex items-center justify-between">
              <div>
