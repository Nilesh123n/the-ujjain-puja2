    ...
    <div className="pt-24 pb-20 animate-in fade-in duration-300">
      ...
      <section className="bg-[#f2b705] text-[#2C1A0E] py-16 px-4 text-center border-b-2 border-[#ffffff]">
        <div className="max-w-4xl mx-auto space-y-3">
          ...
          <h1 className="font-cinzel text-3xl sm:text-5xl font-bold text-[#2C1A0E]">📞 Get in Touch with Us</h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-[#ffffff] border-2 border-[#f2b705] rounded-3xl p-6 text-center shadow-md transition-all text-[#2C1A0E] group">
              ...
              <h3 className="font-cinzel text-base font-bold text-[#2C1A0E]">WhatsApp Us</h3>
              <p className="text-xs text-[#5C3A1E] my-1">Fastest response within minutes</p>
              <a href="https://wa.me/919993540314" target="_blank" rel="noreferrer" className="text-sm font-bold text-[#2C1A0E] block mb-3 hover:text-[#5C3A1E]">
                +91 99935 40314
              </a>
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="inline-block bg-[#ff5c00] text-white font-bold text-xs px-5 py-2 rounded-full shadow-xs hover:bg-[#e05200] transition-colors"
              >
                Chat Now
              </a>
            </div>
            ...
            <div className="bg-[#ffffff] border-2 border-[#f2b705] rounded-3xl p-6 text-center shadow-md transition-all text-[#2C1A0E] group">
              ...
              <h3 className="font-cinzel text-base font-bold text-[#2C1A0E]">Call Directly</h3>
              <p className="text-xs text-[#5C3A1E] my-1">Mon - Sun: 6:00 AM - 10:00 PM</p>
              <a href="tel:+919993540314" className="text-sm font-bold text-[#2C1A0E] block mb-3 hover:text-[#5C3A1E]">
                +91 99935 40314
              </a>
              <a
            ...
            <div className="bg-[#ffffff] border-2 border-[#f2b705] rounded-3xl p-6 text-center shadow-md transition-all text-[#2C1A0E] group">
              ...
              <h3 className="font-cinzel text-base font-bold text-[#2C1A0E]">Email Us</h3>
              <p className="text-xs text-[#5C3A1E] my-1">Detailed queries & receipt requests</p>
              <a href="mailto:hello@theujjainpuja.com" className="text-xs font-bold text-[#2C1A0E] block mb-3 hover:text-[#5C3A1E]">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  <label className="block text-xs font-bold text-[#2C1A0E] uppercase mb-1">Your Name *</label>
                  <input
                    type="text"
                    required
                ...
                <div>
                  <label className="block text-xs font-bold text-[#2C1A0E] uppercase mb-1">Phone Number *</label>
                  <input
                    type="tel"
                    required
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  <label className="block text-xs font-bold text-[#2C1A0E] uppercase mb-1">Email Address</label>
                  <input
                    type="email"
                ...
                <div>
                  <label className="block text-xs font-bold text-[#2C1A0E] uppercase mb-1">Your City / Country</label>
                  <input
                    type="text"
              ...
              <div>
                <label className="block text-xs font-bold text-[#2C1A0E] uppercase mb-1">Subject</label>
                <select
                  value={subject}
              ...
              <div>
                <label className="block text-xs font-bold text-[#2C1A0E] uppercase mb-1">Your Message *</label>
                <textarea
                  rows={4}
                  required
              ...
              <div>
                <label className="block text-xs font-bold text-[#2C1A0E] uppercase mb-1.5">Preferred Contact Mode</label>
                <div className="flex gap-4">
                  <label className="flex items-center gap-1.5 text-xs text-[#2C1A0E] font-medium cursor-pointer">
                    <input
                      type="radio"
                      name="contactPref"
                      value="whatsapp"
                  ...
                  <label className="flex items-center gap-1.5 text-xs text-[#2C1A0E] font-medium cursor-pointer">
                    ...
                    />
                    <i className="fas fa-phone-alt text-[#2C1A0E]"></i> Phone Call
                  </label>
                  <label className="flex items-center gap-1.5 text-xs text-[#2C1A0E] font-medium cursor-pointer">
                    <input
                      type="radio"
